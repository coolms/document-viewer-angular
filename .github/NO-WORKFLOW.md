...
This package has no specs of its own. It is exercised only through the admin application, which is to say it has no test coverage that a workflow here could run even if the install worked.
